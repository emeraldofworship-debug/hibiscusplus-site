          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <img src="https://customer-assets.emergentagent.com/job_a32939dc-1aea-4860-99bb-b62686aca83e/artifacts/5ggfxigz_HibiscuPlus%20Limited%20Dynamic%20Letterform%20Integration%20%281%29.png" alt="HibiscusPlus" className="h-16 w-auto rounded" data-testid="footer-logo" />
              </div>
              ...
              <div className="flex gap-3 mt-6">
                <a href="https://instagram.com/hibiscusplus" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-rose-600 rounded-full flex items-center justify-center transition-colors">
                ...
                <a href="https://facebook.com/hibiscusplus" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-rose-600 rounded-full flex items-center justify-center transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="https://tiktok.com/@hibiscusplus" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-rose-600 rounded-full flex items-center justify-center transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                  </svg>
                </a>
                <a href="https://pinterest.co.uk/hibiscusplus" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-rose-600 rounded-full flex items-center justify-center transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://linkedin.com/company/hibiscusplus" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-rose-600 rounded-full flex items-center justify-center transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="/social-media" className="hover:text-rose-400 transition-colors">Social Media Guide</a></li>
                <li><a href="/company-setup" className="hover:text-rose-400 transition-colors">Company Setup</a></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="flex items-start gap-2">
                  ...
                  <div>
                    <a href="mailto:hello@hibiscusplus.co.uk" className="hover:text-rose-400 transition-colors">
                ...
                <li className="flex items-start gap-2">
                  <Mail className="h-5 w-5 text-rose-400 mt-0.5 flex-shrink-0" />
                  <div>
                    <a href="mailto:orders@hibiscusplus.co.uk" className="hover:text-rose-400 transition-colors">
                      orders@hibiscusplus.co.uk
                    </a>
